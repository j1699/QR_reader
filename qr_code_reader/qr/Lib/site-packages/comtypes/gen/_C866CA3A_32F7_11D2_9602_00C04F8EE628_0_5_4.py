...
__all__ = [
    'SREBookmark', 'DISPID_SPIRule', 'DISPID_SLWPronunciations',
    'SRTEmulated', 'SVP_5', 'SpeechTokenKeyAttributes', 'SPAR_Low',
    'DISPID_SOTs_NewEnum', 'SINone', 'DISPID_SpeechVoice',
    'eLEXTYPE_PRIVATE4', 'SRAExport', 'DISPID_SPILanguageId',
    'DISPID_SpeechPhraseProperty',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SDKLLocalMachine',
    'DISPID_SpeechRecoResult', 'DISPID_SLPPhoneIds',
    'SpeechGrammarTagDictation', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRGetPropertyNumber',
    'SpNullPhoneConverter', 'SpeechVisemeFeature',
    'ISpeechFileStream', 'DISPID_SWFEBitsPerSample',
    'eLEXTYPE_PRIVATE18', 'SPPS_RESERVED3', 'SPPS_Modifier',
    'eLEXTYPE_LETTERTOSOUND', 'SAFTExtendedAudioFormat',
    'SAFTTrueSpeech_8kHz1BitMono', 'STSF_AppData', 'SDTAudio',
    'SLODynamic', 'DISPID_SDKGetBinaryValue', 'ISpPhrase',
    'SPFILEMODE', 'SSSPTRelativeToEnd', 'DISPID_SVEPhoneme',
    'DISPID_SRCCreateGrammar', 'SASPause', 'eLEXTYPE_PRIVATE2',
    'DISPID_SCSBaseStream', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRCEHypothesis', 'DISPID_SGRSTs_NewEnum', 'ISpRecoResult',
    'ISpeechRecoResultTimes', 'SpSharedRecognizer', 'SPEI_RESERVED1',
    'SpeechSpecialTransitionType', 'SGRSTTRule', 'SAFT16kHz16BitMono',
    'DISPID_SRRGetXMLResult', 'SVP_17', 'SASRun', 'STSF_LocalAppData',
    'SpeechCategoryVoices', 'SPEI_TTS_AUDIO_LEVEL',
    'SDA_Two_Trailing_Spaces', 'SPVISEMES',
    'ISpeechLexiconPronunciation', 'SPAO_NONE', 'DISPID_SBSRead',
    'DISPID_SRProfile', 'eLEXTYPE_PRIVATE8', 'SSSPTRelativeToStart',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPCPhoneToId',
    'SPCS_DISABLED', 'DISPID_SPAStartElementInResult',
    'SAFT48kHz8BitStereo', 'DISPID_SVSkip', 'SVP_21',
    'ISpPhoneticAlphabetSelection', 'DISPID_SpeechPhraseRule',
    'SPWT_DISPLAY', 'SVSFlagsAsync', 'SPDKL_CurrentUser',
    'ISpeechAudioStatus', 'SRAONone', 'SpeechWordType',
    'SAFTCCITT_ALaw_11kHzMono', 'SpVoice', 'SRESoundStart',
    'DISPID_SRCreateRecoContext', 'DISPID_SPRules_NewEnum', 'SLTUser',
    'SPEI_PHONEME', 'SpeechTokenIdUserLexicon',
    'Speech_Max_Word_Length', 'SPSERIALIZEDRESULT', 'SRTStandard',
    'SVP_11', 'SRADynamic', 'SPGS_DISABLED', 'DISPID_SDKCreateKey',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SGRSTRule',
    'DISPID_SRGetRecognizers', '_ISpeechVoiceEvents',
    'SPFM_CREATE_ALWAYS', 'SITooLoud', 'DISPID_SRGCommit',
    'DISPID_SOTId', 'SPRST_NUM_STATES', 'DISPID_SVIsUISupported',
    'SpeechRegistryUserRoot', 'SRESoundEnd', 'DISPIDSPTSI',
    'eLEXTYPE_RESERVED6', 'DISPID_SRRTLength', 'DISPID_SGRAddState',
    'SDA_Consume_Leading_Spaces', 'DISPID_SLPPartOfSpeech',
    'SWPUnknownWordUnpronounceable', 'SRSEDone',
    'ISpeechPhraseReplacements', 'DISPID_SPIGetText',
    'SPCT_DICTATION', 'DISPID_SpeechAudioFormat',
    'DISPID_SGRSTransitions', 'SAFTDefault', 'SpeechAudioState',
    'SPEI_RECOGNITION', 'DISPID_SRGetFormat', 'SAFT8kHz8BitMono',
    'SGRSTTEpsilon', 'SPSHT_OTHER', '_ISpeechRecoContextEvents',
    'DISPID_SLPLangId', 'ISpObjectWithToken', 'SECHighConfidence',
    'DISPID_SpeechLexiconWords', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpMMAudioIn', 'DISPID_SVSpeakStream', 'SpeechVisemeType',
    'SPWF_INPUT', 'DISPID_SVESentenceBoundary',
    'DISPID_SDKGetlongValue', 'DISPID_SAEventHandle', 'SPPHRASE',
    'ISpeechRecoResult', 'SPEI_SR_PRIVATE', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRCEAudioLevel', 'SPWORDPRONUNCIATIONLIST', 'SVP_20',
    'DISPID_SVAudioOutputStream', 'SREStreamEnd', 'DISPID_SVResume',
    'ISpeechXMLRecoResult', 'SVSFUnusedFlags', 'SITooFast',
    'SPEI_START_SR_STREAM', 'SLTApp', 'DISPID_SOTsCount',
    'DISPID_SpeechRecoResult2', 'DISPID_SpeechPhraseBuilder',
    'SPFM_CREATE', 'DISPID_SASCurrentSeekPosition',
    'SPEI_VOICE_CHANGE', 'SGDSActiveWithAutoPause',
    'DISPID_SLRemovePronunciation', 'SpeechTokenContext',
    'SPSSuppressWord', 'DISPID_SVGetAudioOutputs', 'SWTAdded',
    'SPGS_EXCLUSIVE', 'SpeechRetainedAudioOptions',
    'DISPID_SPIEnginePrivateData', 'DISPID_SABufferInfo',
    'SPFM_NUM_MODES', 'DISPID_SASFreeBufferSpace', 'SVP_1',
    'SAFTADPCM_8kHzStereo', 'DISPID_SFSClose', 'DISPID_SPAsItem',
    'SAFT8kHz16BitStereo', 'SpResourceManager',
    'DISPID_SRRRecoContext', 'SPPHRASEREPLACEMENT',
    'SPFM_OPEN_READWRITE', 'DISPID_SGRs_NewEnum',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFTADPCM_11kHzStereo',
    'ISpNotifyTranslator', 'SPRECOGNIZERSTATUS',
    'DISPID_SWFEExtraData', 'DISPID_SRGSetWordSequenceData',
    'SPSInterjection', 'DISPID_SOTIsUISupported',
    'SREPropertyNumChange', 'SRSInactiveWithPurge',
    'DISPID_SRCERecognition', 'SRERecognition',
    'SAFT22kHz16BitStereo', 'SAFTCCITT_ALaw_44kHzMono',
    'SPSEMANTICFORMAT', 'DISPID_SASNonBlockingIO',
    'SAFT44kHz16BitStereo', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRRAudioFormat', 'DISPID_SOTCEnumerateTokens',
    'SpeechVoiceEvents', 'SPVPRI_OVER', 'SREAdaptation',
    'DISPID_SWFEChannels', 'DISPID_SVSInputWordPosition',
    'DISPID_SRAudioInputStream', 'DISPID_SGRsItem',
    'eLEXTYPE_PRIVATE7', 'DISPID_SVSLastResult', 'SAFT16kHz8BitMono',
    'DISPID_SOTGetAttribute', 'ISpeechGrammarRules', 'SPWORD',
    'DISPID_SRCEBookmark', 'SAFT12kHz16BitMono',
    'SpeechRecognitionType', 'SP_VISEME_2', 'SpStreamFormatConverter',
    'DISPID_SRCERecognizerStateChange', 'SPPS_RESERVED2',
    'SVEEndInputStream', 'SVP_6', 'SPLO_DYNAMIC', 'SGDSInactive',
    'DISPID_SPRFirstElement', 'eLEXTYPE_PRIVATE14',
    'SpeechWordPronounceable', 'SpeechCategoryRecognizers',
    'SAFT22kHz8BitMono', 'SREAllEvents', 'SGSDisabled',
    'DISPID_SDKSetLongValue', 'DISPID_SpeechLexiconWord',
    'ISpObjectToken', 'STCInprocServer', 'DISPID_SPRulesItem',
    'DISPID_SVSpeak', 'DISPID_SPIGetDisplayAttributes',
    'ISpeechLexiconWord', 'SAFT32kHz16BitMono', 'SRAInterpreter',
    'SPAUDIOBUFFERINFO', 'SPAR_Medium', 'DISPID_SpeechFileStream',
    'SAFT32kHz16BitStereo', 'SpeechPropertyHighConfidenceThreshold',
    'ISpeechGrammarRule', 'eWORDTYPE_DELETED',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpInProcRecoContext', 'SPPS_Noun', 'SP_VISEME_18',
    'ISpRecoCategory', 'DISPID_SOTCId', 'DISPID_SRIsShared',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SVEStreamStart',
    'DISPID_SGRsDynamic', 'DISPID_SVGetProfiles', 'DISPID_SPPId',
    'DISPID_SGRSTPropertyName', 'SPPS_Interjection', 'WAVEFORMATEX',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SPRText',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRRPhraseInfo',
    'DISPID_SVSInputSentenceLength', 'SpAudioFormat',
    'SAFT11kHz8BitMono', 'DISPID_SPIStartTime', 'eWORDTYPE_ADDED',
    'DISPID_SPRsCount', 'DISPID_SRCERecognitionForOtherContext',
    'SRERecoOtherContext', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SGRSTPropertyValue', 'SLOStatic', 'DISPID_SRRAlternates',
    'DISPID_SRRTTickCount', '_RemotableHandle', 'SVPOver',
    'SAFT48kHz16BitStereo', 'DISPID_SGRSTText', 'SVEAudioLevel',
    'DISPID_SPIGrammarId', 'DISPID_SpeechPhraseReplacement',
    'SPCT_SLEEP', 'DISPID_SPPBRestorePhraseFromMemory',
    'ISpRecoContext', 'SVSFNLPMask', 'SPPS_NotOverriden',
    'SREPrivate', 'SVSFVoiceMask', 'SDKLDefaultLocation',
    'SDTProperty', 'Speech_Default_Weight', 'eLEXTYPE_PRIVATE5',
    'SAFTText', 'SAFT44kHz16BitMono', 'DISPID_SRAudioInput',
    'ISpeechRecognizerStatus', 'SVEAllEvents', 'SSFMOpenForRead',
    'SRSEIsSpeaking', 'ISpRecoContext2', 'SpeechRecoContextState',
    'SPPROPERTYINFO', 'ISpLexicon', 'DISPID_SpeechObjectTokens',
    'eLEXTYPE_RESERVED7', 'ISpeechLexiconWords',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SVAudioOutput',
    'eLEXTYPE_RESERVED10', 'DISPID_SLGetPronunciations',
    'DISPID_SRGState', 'SpeechEngineProperties',
    'SpeechTokenValueCLSID', 'SpFileStream', 'SPSVerb',
    'DISPID_SRRSetTextFeedback', 'IInternetSecurityManager',
    'ISpProperties', 'SPPS_LMA', 'SP_VISEME_20',
    'SpeechEmulationCompareFlags', 'SDTPronunciation',
    'SpeechRuleAttributes', 'SPPARTOFSPEECH',
    'SpeechPropertyAdaptationOn', 'SPDKL_CurrentConfig', 'SPXRO_SML',
    'SPEI_SOUND_START', 'SAFTGSM610_8kHzMono', 'SPEI_WORD_BOUNDARY',
    'DISPID_SPEAudioTimeOffset', 'SVF_Emphasis',
    'DISPID_SVEEnginePrivate', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SOTDisplayUI', 'SRCS_Disabled', 'ISpeechPhraseProperty',
    'DISPID_SRCVoice', 'ISpeechPhraseElement', 'SGRSTTTextBuffer',
    'DISPID_SWFESamplesPerSec', 'ISpPhoneConverter',
    'SDKLCurrentConfig', 'SpeechMicTraining',
    'DISPID_SRCEventInterests', 'SPPS_Function',
    'DISPID_SPRuleEngineConfidence', 'ISpXMLRecoResult',
    'DISPID_SRGCmdSetRuleIdState', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpeechAudioFormatType', 'SVSFDefault', 'SVEBookmark',
    'SVEPhoneme', 'Speech_StreamPos_RealTime',
    'SREPropertyStringChange', 'DISPID_SDKDeleteKey',
    'DISPID_SGRInitialState', 'DISPID_SRGCmdLoadFromMemory',
    'SDTRule', 'SPEI_SENTENCE_BOUNDARY', 'SPCONTEXTSTATE',
    'DISPID_SPEAudioSizeTime', 'SAFTNonStandardFormat',
    'DISPID_SPERequiredConfidence', 'eLEXTYPE_PRIVATE10', 'UINT_PTR',
    'SpeechPropertyResourceUsage', 'SPRECOCONTEXTSTATUS',
    'SP_VISEME_15', 'SPEI_UNDEFINED', 'DISPID_SABIMinNotification',
    'SRADefaultToActive', 'DISPID_SRSetPropertyString',
    'DISPID_SLGetGenerationChange', '_SPAUDIOSTATE',
    'DISPID_SASetState', 'DISPID_SRRecognizer', 'SPEI_RESERVED5',
    'DISPID_SLWType', 'SAFTADPCM_44kHzStereo', 'SPAUDIOSTATUS',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpStream',
    'DISPID_SpeechPhraseAlternates', 'SAFT44kHz8BitStereo', 'SBONone',
    'SSFMCreate', 'eLEXTYPE_PRIVATE1', 'DISPID_SWFEAvgBytesPerSec',
    'SREHypothesis', 'SPEI_START_INPUT_STREAM', 'SVEStartInputStream',
    'SPRULE', 'SRTExtendableParse', 'DISPID_SRRAudio',
    'DISPID_SpeechAudioStatus',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVP_12',
    'DISPID_SpeechGrammarRules', 'DISPID_SPPConfidence', 'DISPIDSPRG',
    'SAFT11kHz8BitStereo',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechTokenKeyUI', 'SPSERIALIZEDPHRASE',
    'SAFTCCITT_ALaw_8kHzStereo', 'STSF_CommonAppData', 'SSTTWildcard',
    'SPWORDPRONOUNCEABLE', 'DISPID_SpeechPhraseElement',
    'DISPID_SPEs_NewEnum', 'SSFMCreateForWrite',
    'DISPID_SRCEInterference', 'SVSFParseMask',
    'SpeechBookmarkOptions', 'SWPKnownWordPronounceable',
    'SpeechInterference', 'SpObjectTokenCategory', 'SDKLCurrentUser',
    'DISPID_SRGSetTextSelection', 'ISpeechMemoryStream',
    'ISpeechPhraseInfo', 'DISPID_SGRsAdd', 'DISPID_SRCEAdaptation',
    'SPSHORTCUTPAIR', 'SPGRAMMARSTATE', 'DISPID_SWFEFormatTag',
    'DISPID_SRGetPropertyString', 'DISPID_SGRSTNextState',
    'SECFDefault', 'SPWF_SRENGINE', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SLPType', 'DISPID_SRGDictationUnload',
    'DISPID_SPRDisplayAttributes', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFT24kHz8BitStereo', 'DISPID_SVGetAudioInputs',
    'DISPID_SRGDictationLoad', 'SPFM_OPEN_READONLY',
    'ISpeechPhraseRules', 'DISPID_SGRAttributes', 'SPLEXICONTYPE',
    'SVSFPurgeBeforeSpeak', 'SP_VISEME_1',
    'DISPID_SRCCreateResultFromMemory', 'SPVOICESTATUS',
    'ISpeechAudio', 'ISpeechRecoResultDispatch', 'SPAUDIOSTATE',
    'DISPID_SPRuleChildren', 'SpeechCategoryPhoneConverters',
    'SVESentenceBoundary', 'DISPIDSPTSI_SelectionOffset',
    'SWTDeleted', 'SPRULESTATE', 'LONG_PTR', 'SpeechFormatType',
    'SpeechDiscardType', 'SpPhoneticAlphabetConverter', 'SGLexical',
    'SpeechVoiceSpeakFlags', 'SPEI_INTERFERENCE',
    'SAFT22kHz16BitMono', 'DISPID_SpeechGrammarRuleState',
    'eLEXTYPE_PRIVATE17', 'SPINTERFERENCE_LATENCY_WARNING',
    'ISpObjectTokenCategory', 'SPPHRASEELEMENT', 'SpeechRecoEvents',
    'DISPID_SVPause', 'SPINTERFERENCE_TOOLOUD', 'SVP_15', 'SASStop',
    'ISpeechCustomStream', 'DISPID_SVWaitUntilDone',
    'DISPID_SRSClsidEngine', 'SPXRO_Alternates_SML',
    'SVSFParseAutodetect', 'DISPID_SOTDataKey', 'SRARoot',
    'eLEXTYPE_PRIVATE20', 'DISPID_SPEEngineConfidence',
    'SPINTERFERENCE_TOOQUIET',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SRAImport',
    'SAFT32kHz8BitStereo', 'IStream', 'SPEI_PHRASE_START',
    'SPEI_SR_RETAINEDAUDIO', 'SRTSMLTimeout',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRCState',
    'SPVPRI_ALERT', 'DISPID_SpeechObjectToken',
    'SpeechGrammarTagWildcard', 'SASClosed',
    'SAFTCCITT_uLaw_22kHzStereo', 'eLEXTYPE_RESERVED4', 'SVEPrivate',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPARecoResult',
    'DISPID_SpeechVoiceEvent', 'SPSMF_UPS', 'eLEXTYPE_USER_SHORTCUT',
    'SRAORetainAudio', 'ISpeechAudioBufferInfo', 'SP_VISEME_3',
    'SDTDisplayText', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SPRs_NewEnum', 'DISPID_SRCEPhraseStart',
    'SAFTNoAssignedFormat', 'SPCT_SUB_DICTATION',
    'SAFT16kHz8BitStereo', 'DISPID_SPISaveToMemory',
    'DISPID_SRSetPropertyNumber', 'SAFT32kHz8BitMono',
    'DISPID_SVSInputWordLength', 'DISPID_SRStatus', 'SPAS_STOP',
    'SPAS_RUN', 'DISPID_SAFSetWaveFormatEx', 'SpeechCategoryAudioOut',
    'SVP_7', 'ISpNotifySink', 'DISPID_SRGRecoContext',
    'tagSPTEXTSELECTIONINFO', 'SpCustomStream', 'SPCT_COMMAND',
    'DISPID_SDKGetStringValue', 'DISPID_SMSALineId',
    'DISPID_SRGRules', 'SPWORDPRONUNCIATION',
    'DISPID_SGRSAddSpecialTransition', 'SpeechPropertyResponseSpeed',
    'SPPS_RESERVED4', 'ISpeechPhraseElements', 'SECNormalConfidence',
    'ISpeechRecognizer', 'DISPID_SPAsCount', 'SPWT_PRONUNCIATION',
    'SVSFNLPSpeakPunc', 'SPAR_Unknown', 'SGDSActive',
    'DISPID_SpeechRecoResultTimes', 'SITooQuiet', 'SPEI_MIN_SR',
    'SP_VISEME_16', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRCResume',
    'ISpeechObjectTokenCategory', 'IEnumString',
    'DISPID_SRCRequestedUIType', 'SINoise',
    'ISpeechPhraseInfoBuilder', 'SPDATAKEYLOCATION', 'tagSTATSTG',
    'DISPID_SRSAudioStatus', 'DISPID_SRSCurrentStreamNumber',
    'ISpeechVoice', 'DISPID_SABufferNotifySize',
    'DISPID_SRCEEnginePrivate', 'ISpGrammarBuilder',
    ...
    'ISpSerializeState', 'SPEI_SOUND_END', 'SPEI_RESERVED2',
    'ISpEventSource', 'SPWAVEFORMATTYPE',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SLWLangId',
    'DISPID_SVPriority', 'DISPID_SRIsUISupported', 'SPEI_ADAPTATION',
    'SPCT_SUB_COMMAND', 'SAFT44kHz8BitMono', 'SpMMAudioOut',
    'DISPID_SpeechAudio', 'DISPID_SpeechPhraseProperties',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRGDictationSetState',
    'SAFTADPCM_44kHzMono', 'SpPhraseInfoBuilder', 'DISPID_SRGReset',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SpWaveFormatEx',
    'SGDSActiveUserDelimited', 'SPBO_TIME_UNITS',
    'DISPID_SRDisplayUI', 'SPEI_END_SR_STREAM',
    'DISPID_SOTGetDescription', 'DISPID_SMSGetData',
    'SpeechLexiconType', 'SP_VISEME_21', 'DISPID_SOTsItem',
    'DISPID_SPANumberOfElementsInResult', 'eLEXTYPE_PRIVATE19',
    'SpeechCategoryAppLexicons', 'DISPID_SPCIdToPhone',
    'SGSExclusive', 'SPPHRASERULE', 'SPEI_TTS_PRIVATE',
    'ISpeechLexicon', 'SpeechVoiceSkipTypeSentence', 'SPEI_MAX_SR',
    'SPGRAMMARWORDTYPE', 'DISPID_SVSRunningState', 'SPPS_Noncontent',
    'SPAS_PAUSE', 'SpeechDisplayAttributes', 'SRTAutopause',
    'DISPID_SLWsCount', 'DISPID_SPPValue', 'ISpRecognizer',
    'ISpeechRecoGrammar', 'ISpeechPhraseAlternates', 'SPCATEGORYTYPE',
    'DISPID_SVDisplayUI', 'DISPID_SVStatus', 'DISPID_SMSADeviceId',
    'DISPID_SRCRecognizer', 'ISpeechRecoContext', 'SP_VISEME_5',
    'DISPID_SADefaultFormat', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SGRSAddRuleTransition', 'SVP_18', 'DISPID_SPPChildren',
    'eLEXTYPE_RESERVED8', 'DISPID_SAStatus', 'SREFalseRecognition',
    'SPWT_LEXICAL', 'SGSEnabled', 'DISPID_SABIBufferSize',
    'SpeechCategoryAudioIn', 'SPSLMA', 'eLEXTYPE_PRIVATE11',
    'SVSFParseSsml', 'DISPID_SPELexicalForm',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPRST_ACTIVE_ALWAYS', 'STCAll', 'SpeechUserTraining',
    'DISPID_SVEWord', 'DISPID_SRRDiscardResultInfo', 'SBOPause',
    'DISPID_SDKEnumValues', 'SPPS_Unknown', 'SAFTGSM610_11kHzMono',
    'DISPID_SGRSTWeight', 'ISpPhoneticAlphabetConverter',
    'DISPID_SPRuleConfidence', 'DISPID_SPIReplacements',
    'SPEI_END_INPUT_STREAM', 'DISPID_SREmulateRecognition',
    'SPSTREAMFORMATTYPE', 'DISPID_SPEsCount',
    'SPINTERFERENCE_NOSIGNAL', 'SVPNormal', 'SpStream',
    'DISPID_SRRTimes', 'SPAS_CLOSED', 'DISPID_SpeechRecoContext',
    'DISPID_SPEDisplayText', 'SPEI_SR_BOOKMARK', 'DISPID_SGRSTsCount',
    'SECFIgnoreKanaType', 'SPINTERFERENCE_TOOSLOW', 'SPEI_MAX_TTS',
    'Speech_Max_Pron_Length', 'DISPID_SVSyncronousSpeakTimeout',
    'SP_VISEME_13', 'SGLexicalNoSpecialChars', 'ISpShortcut',
    'SPSMF_SAPI_PROPERTIES', 'SpeechGrammarState', 'SP_VISEME_9',
    'DISPID_SVVoice', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SOTCreateInstance', 'SpeechVoicePriority',
    'eLEXTYPE_USER', 'SVF_None', 'DISPID_SRCESoundEnd',
    'tagSPPROPERTYINFO', 'SECFIgnoreCase',
    'ISpeechGrammarRuleStateTransitions', 'IEnumSpObjectTokens',
    'SAFT8kHz8BitStereo', 'SpeechDictationTopicSpelling',
    'DISPID_SPERetainedStreamOffset', 'SpeechVoiceCategoryTTSRate',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPIDSPTSI_ActiveOffset',
    'SECLowConfidence', 'SVSFIsFilename', 'SAFT16kHz16BitStereo',
    'SpeechPropertyNormalConfidenceThreshold', 'SRSActiveAlways',
    'DISPID_SLPsItem', 'SRSActive', 'DISPID_SGRSTType',
    'SpeechEngineConfidence', 'DISPID_SVVolume', 'SPWORDLIST',
    'DISPID_SRGId', 'DISPID_SGRSTPropertyId', 'DISPID_SMSSetData',
    'DISPID_SRSNumberOfActiveRules', 'ISpVoice',
    'SAFT11kHz16BitStereo', 'ISpRecoGrammar2',
    'DISPID_SRCRetainedAudioFormat', 'ISpEventSink',
    'DISPID_SVSPhonemeId', 'DISPID_SpeechRecognizer',
    'ISpeechResourceLoader', 'DISPID_SVSLastBookmarkId',
    'DISPID_SLWWord', 'SPDKL_LocalMachine', 'SPEI_RESERVED6',
    'DISPID_SRCPause', 'DISPID_SDKOpenKey', 'SPAUDIOOPTIONS',
    'SpeechGrammarRuleStateTransitionType', 'SPVPRIORITY',
    'SVSFParseSapi', 'ISpeechDataKey', 'SpTextSelectionInformation',
    'DISPID_SVGetVoices', 'SAFTGSM610_44kHzMono',
    'DISPID_SpeechMemoryStream', 'SFTSREngine', 'STSF_FlagCreate',
    'DISPID_SGRName', 'SpeechDataKeyLocation',
    'DISPID_SPEActualConfidence', 'SpObjectToken',
    'SAFTCCITT_uLaw_8kHzMono', 'STCInprocHandler',
    'DISPID_SPIEngineId', 'SAFT12kHz16BitStereo',
    'SPEI_SR_AUDIO_LEVEL', 'SVSFIsXML', 'DISPID_SGRAddResource',
    'DISPID_SPEPronunciation', 'SpeechAudioProperties',
    'ISpeechGrammarRuleState', 'DISPID_SVSLastBookmark',
    'DISPID_SPRuleParent', 'DISPID_SOTMatchesAttributes',
    'DISPID_SPPs_NewEnum', 'SPEI_RESERVED3', 'ISpStreamFormat',
    'DISPID_SPPEngineConfidence', 'DISPID_SPEAudioSizeBytes',
    'ISpeechLexiconPronunciations', 'SPSNoun',
    'DISPID_SPRNumberOfElements', 'SVP_2', 'SPBO_PAUSE',
    'ISpNotifySource', 'SPRST_INACTIVE', 'SPGS_ENABLED',
    'DISPID_SPEsItem', 'SAFT24kHz16BitMono', 'DISPID_SRRTStreamTime',
    'ISpDataKey', 'SAFT48kHz16BitMono', 'DISPID_SPAs_NewEnum',
    'SpeechAddRemoveWord', 'SECFNoSpecialChars', 'STCLocalServer',
    'DISPID_SPCLangId', 'SPEI_RECO_STATE_CHANGE', 'SPEI_TTS_BOOKMARK',
    'SPBO_NONE', 'SVP_14', 'DISPID_SAFType', 'DISPID_SASState',
    'DISPID_SBSFormat', 'SGRSTTDictation', 'DISPID_SPPFirstElement',
    'SPINTERFERENCE_NONE', 'SP_VISEME_0', 'SPSHORTCUTTYPE',
    'SPPS_RESERVED1', 'DISPID_SRGIsPronounceable', 'SPRECOSTATE',
    'SpeechAllElements', 'ISpeechWaveFormatEx',
    'SpeechAudioFormatGUIDWave', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFT24kHz8BitMono', 'DISPID_SVEAudioLevel',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SAFGuid',
    'DISPID_SPACommit', 'SRERequestUI', 'DISPID_SLGenerationId',
    'SECFIgnoreWidth', 'DISPID_SRCRetainedAudio', 'eLEXTYPE_PRIVATE6',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SpeechPhraseInfo',
    'SPLOADOPTIONS', 'SP_VISEME_11', 'SGRSTTWord',
    'ISpeechMMSysAudio', 'DISPID_SDKSetStringValue',
    'SPSHORTCUTPAIRLIST', 'DISPIDSPTSI_SelectionLength',
    'SDTLexicalForm', 'ISpRecognizer3', 'SP_VISEME_17',
    'DISPID_SpeechPhraseReplacements', 'SITooSlow',
    'ISpResourceManager', 'DISPID_SpeechAudioBufferInfo',
    'SPEI_VISEME', 'DISPID_SGRsCommitAndSave', 'ISpeechObjectTokens',
    'SPEI_REQUEST_UI', 'DISPID_SRGCmdLoadFromFile', 'STCRemoteServer',
    'DISPID_SPIElements', 'DISPID_SpeechPhraseRules',
    'SPSNotOverriden', 'DISPID_SpeechLexiconProns', 'SVP_3',
    'SpeechPartOfSpeech', 'IInternetSecurityMgrSite',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPAPhraseInfo', 'DISPID_SDKEnumKeys',
    'SVP_9', 'DISPID_SPPsCount', 'SVPAlert', 'DISPID_SPIProperties',
    'SRTReSent', 'eLEXTYPE_RESERVED9', 'DISPID_SVRate',
    'SVEWordBoundary', 'DISPID_SRRSaveToMemory',
    'DISPID_SOTCGetDataKey', 'DISPID_SPIAudioStreamPosition',
    'SPVPRI_NORMAL', 'DISPID_SVSVisemeId',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SFSOpen',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpRecoGrammar',
    'SAFT48kHz8BitMono', 'SVSFIsNotXML', 'eLEXTYPE_PRIVATE13',
    'eLEXTYPE_PRIVATE3', 'DISPID_SpeechPhoneConverter',
    'SREInterference', 'ISpRecognizer2', 'SPRS_ACTIVE',
    'DISPID_SRState', 'SpCompressedLexicon',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPADAPTATIONRELEVANCE', 'SpeechLoadOption', 'DISPID_SBSWrite',
    'SPINTERFERENCE_NOISE', 'DISPID_SPPsItem', 'ISpPhraseAlt',
    'DISPID_SpeechDataKey', 'SGDisplay', 'SVP_10', 'SVP_19',
    'SpeechGrammarTagUnlimitedDictation', 'eLEXTYPE_PRIVATE15',
    'SPAR_High', 'SSFMOpenReadWrite', 'SDTReplacement',
    'SpeechTokenKeyFiles', 'SpeechRecognizerState',
    'SPRECORESULTTIMES', 'eLEXTYPE_PRIVATE16',
    'SpeechRegistryLocalMachineRoot', 'SPRS_INACTIVE',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPRsItem',
    'SDA_No_Trailing_Space', 'SVSFPersistXML',
    'ISpeechPhraseProperties', 'DISPID_SWFEBlockAlign',
    ...
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SVSpeakCompleteEvent',
    'SAFTGSM610_22kHzMono', 'DISPID_SLGetWords',
    'SpeechStreamSeekPositionType', 'DISPID_SpeechPhraseAlternate',
    'SVEVoiceChange', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SpeechWaveFormatEx', 'SP_VISEME_19', 'SAFTADPCM_8kHzMono',
    'DISPID_SpeechGrammarRule', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpeechGrammarWordType', 'DISPID_SpeechVoiceStatus',
    'DISPID_SOTRemove', 'DISPID_SpeechMMSysAudio', 'SRCS_Enabled',
    'SpeechTokenShellFolder', 'DISPID_SOTCDefault',
    'SPSHT_NotOverriden', 'DISPID_SPPParent', 'SDTAlternates',
    'DISPID_SRGCmdLoadFromObject', 'SpLexicon',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpeechAudioVolume',
    'DISPID_SVEViseme', 'SPPHRASEPROPERTY', 'SVP_13',
    'SECFEmulateResult', 'SVEViseme', 'SAFTADPCM_11kHzMono',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SLPs_NewEnum',
    'DISPID_SVEBookmark', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SABIEventBias', 'ISpeechPhoneConverter',
    'DISPID_SGRClear', 'SSTTDictation', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPEI_MIN_TTS', 'SP_VISEME_12', 'SpeechCategoryRecoProfiles',
    'SpeechRuleState', 'ISpeechObjectToken',
    'DISPID_SpeechCustomStream', 'SPXMLRESULTOPTIONS',
    'DISPID_SGRsCommit', 'SPLO_STATIC', 'SPSFunction',
    'DISPID_SOTCSetId', 'SREPhraseStart', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SVAlertBoundary', 'SDA_One_Trailing_Space',
    'SpPhoneConverter', '__MIDL_IWinTypes_0009',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SDKDeleteValue',
    'DISPID_SRCEEndStream', 'ISpAudio', 'SpeechStreamFileMode',
    'ISequentialStream', 'SINoSignal', 'SPPS_Verb', 'SPEVENT',
    'SpInprocRecognizer', 'DISPID_SpeechPhraseElements',
    'SPEVENTENUM', 'SVP_0', 'SPDKL_DefaultLocation',
    'DISPID_SVEventInterests', 'DISPID_SLAddPronunciation',
    'DISPID_SGRSTsItem', 'SpMemoryStream', 'DISPID_SGRSRule',
    'ISpeechPhraseRule', 'ISpeechGrammarRuleStateTransition',
    'eLEXTYPE_APP', 'DISPID_SGRSAddWordTransition',
    'SPEVENTSOURCEINFO', 'DISPID_SLWs_NewEnum', 'SP_VISEME_7',
    'DISPID_SRCAudioInInterferenceStatus', 'SVP_4',
    'DISPID_SpeechBaseStream', 'SREAudioLevel',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SOTCategory',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRCESoundStart',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SGRsFindRule', 'SDTAll',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpMMSysAudio',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SLWsItem', 'SAFTCCITT_uLaw_11kHzMono',
    'SPPS_SuppressWord', 'DISPID_SPIRetainedSizeBytes',
    'SPEI_HYPOTHESIS', 'SRSInactive', 'DISPID_SLPsCount',
    'ISpeechPhraseReplacement', 'DISPID_SRRSpeakAudio',
    'ISpStreamFormatConverter', 'DISPID_SBSSeek', 'SP_VISEME_10',
    'DISPID_SPRuleName', 'DISPID_SpeechLexicon', 'SPSUnknown',
    'DISPID_SPRulesCount', 'SAFTADPCM_22kHzMono',
    'SAFT12kHz8BitStereo', 'SAFT22kHz8BitStereo', 'DISPID_SPRuleId',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCBookmark',
    'SAFT12kHz8BitMono', 'SPSModifier', 'ISpeechPhraseAlternate',
    'Speech_StreamPos_Asap', 'ISpeechRecoResult2',
    'SPAO_RETAIN_AUDIO', 'DISPID_SRCERequestUI', 'SGRSTTWildcard',
    'SPRST_ACTIVE', 'SPCS_ENABLED', 'ISpeechAudioFormat', 'SVP_16',
    'SP_VISEME_6', 'SPSEMANTICERRORINFO', 'SPWORDTYPE',
    'DISPID_SMSAMMHandle', 'SPTEXTSELECTIONINFO', 'SFTInput',
    'SPSHT_EMAIL', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SDKSetBinaryValue', 'SREStateChange', 'SP_VISEME_8',
    'SPBO_AHEAD', 'SVF_Stressed', 'DISPID_SOTSetId',
    'DISPID_SVEStreamEnd', 'SP_VISEME_4', 'SPINTERFERENCE',
    ...
    'SPBOOKMARKOPTIONS', 'SWPUnknownWordPronounceable', 'SRATopLevel',
    'SP_VISEME_14', 'DISPID_SVEVoiceChange',
    'ISpeechTextSelectionInformation', 'SPBINARYGRAMMAR',
    'SGPronounciation', 'DISPID_SAVolume', 'DISPID_SGRsCount',
    'DISPID_SRCEPropertyNumberChange', 'ISpeechVoiceStatus',
    'SAFT8kHz16BitMono', 'SPSHT_Unknown', 'DISPID_SLPSymbolic',
    'DISPID_SPPName', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SRCEStartStream',
    'DISPID_SPRuleFirstElement', 'SpNotifyTranslator', 'DISPID_SGRId',
    'SpMMAudioEnum', 'DISPID_SRCSetAdaptationData',
    'DISPID_SpeechRecognizerStatus', 'SpeechRecoProfileProperties',
    'SVP_8'
]

_check_version('1.1.14', 1652419620.875928)
